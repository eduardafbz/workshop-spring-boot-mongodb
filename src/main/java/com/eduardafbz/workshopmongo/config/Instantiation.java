...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, maria, fmt.parse("21/03/2018"), "Partiu viagem!", "Vou viajar para São Paulo. Abraços!");
		Post post2 = new Post(null, maria, fmt.parse("23/03/2018"), "Bom dia", "Acordei feliz hoje!");
